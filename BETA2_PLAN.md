...
- **Depends on**: 0.1, 0.3 (need files extracted to import them)
- **Issue**: #TBD
...
- **Depends on**: 1.2 (tests for safe_path exist)
- **Issue**: #TBD
...
- **Depends on**: 1.1 (snapshot tests catch compose changes)
- **Issue**: #TBD
...
- **Depends on**: 1.3 (RAG tests exist)
- **Issue**: #TBD
...
- **Depends on**: 1.1, 1.2, 1.3 (tests must exist before refactoring)
- **Issue**: #TBD
...
Phase 0: Foundation
  0.1 Tooling ──────────────────────────────────────┐
  0.2 Map extraction ──► 0.3 Extract to files ──────┤
                                                     │
Phase 1: Tests                                       │
  1.4 Schema tests ◄────────────────────── 0.1 ◄─────┤
  1.1 Fidelity tests ◄──────────────────── 0.3 ◄─────┤
  1.2 Unit tests ◄──────────────────── 0.1 + 0.3     │
  1.3 Pipeline tests ◄────────────── 0.3 + 1.2       │
                                                      │
Phase 2: Security                                     │
  2.1 Path traversals ◄──────────────────── 1.2      │
  2.2 Network defaults ◄─────────────────── 1.1      │
  2.3 CORS / exceptions ◄──────────────── 0.3        │
  2.4 EMBED_DIM ◄────────────────────────── 1.3      │
                                                      │
Phase 3: Code Quality                                 │
  3.1 Lint baseline ◄──────────────────── 0.3        │
  3.2 Type hints ◄───────────────────────── 3.1      │
  3.3 Refactor monoliths ◄──── 1.1 + 1.2 + 1.3      │
  3.4 DRY / versions ◄────────────────── 0.3         │
  3.5 Bug fixes ◄──────────────────────── 1.1        │
                                                      │
